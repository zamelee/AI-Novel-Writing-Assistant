export const queryKeys = {
  novels: {
    ...
    autoDirectorTaskLatest: (id: string) => ["novels", "auto-director-task-latest", id] as const,
    chapterTitleDiversityReport: (id: string) => ["novels", "chapter-title-diversity-report", id] as const,
    directorBookAutomation: (id: string) => ["novels", "director-book-automation", id] as const,
    directorInspector: (id: string) => ["novels", "director-inspector", id] as const,
    directorInspectorLocks: (id: string) => ["novels", "director-inspector-locks", id] as const,
